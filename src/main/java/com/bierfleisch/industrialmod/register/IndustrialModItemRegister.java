...
import com.bierfleisch.industrialmod.item.ore.RawUraniumItem;
...
public class IndustrialModItemRegister {
    ...
    public static final RawUraniumItem RAW_URANIUM_ITEM = new RawUraniumItem();
    ...
    public static void registerAll() {
        ...
        Registry.register(Registries.ITEM, new Identifier(IndustrialMod.MOD_ID, "raw_uranium"), RAW_URANIUM_ITEM);
    }
}
